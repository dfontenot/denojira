/* esm.sh - react-dom@18.3.1/server */
import*as __0$ from"/react@18.3.1/es2020/react.development.mjs";var require=n=>{const e=m=>typeof m.default<"u"?m.default:m,c=m=>Object.assign({__esModule:true},m);switch(n){case"react":return e(__0$);default:console.error('module "'+n+'" not found');return null;}};
...
// endpoint.js
var cjsm = __toESM(require_server_browser());
var { version, renderToString, renderToStaticMarkup, renderToNodeStream, renderToStaticNodeStream, renderToReadableStream } = cjsm;
