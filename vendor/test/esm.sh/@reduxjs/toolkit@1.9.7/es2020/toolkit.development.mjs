/* esm.sh - @reduxjs/toolkit@1.9.7 */
import __Process$ from "/node/process.mjs";
// node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js
import { enableES5 } from "/immer@^9.0.21?target=es2020&dev";
export * from "/redux@^4.2.1?target=es2020&dev";
import { default as default2, current as current2, freeze, original, isDraft as isDraft4 } from "/immer@^9.0.21?target=es2020&dev";
import { createSelector as createSelector2 } from "/reselect@^4.1.8?target=es2020&dev";
import { current, isDraft } from "/immer@^9.0.21?target=es2020&dev";
import { createSelector } from "/reselect@^4.1.8?target=es2020&dev";
import { createStore, compose as compose2, applyMiddleware, combineReducers } from "/redux@^4.2.1?target=es2020&dev";
import { compose } from "/redux@^4.2.1?target=es2020&dev";
import thunkMiddleware from "/redux-thunk@^2.4.2?target=es2020&dev";
import createNextState, { isDraftable } from "/immer@^9.0.21?target=es2020&dev";
import createNextState2, { isDraft as isDraft2, isDraftable as isDraftable2 } from "/immer@^9.0.21?target=es2020&dev";
import createNextState3, { isDraft as isDraft3 } from "/immer@^9.0.21?target=es2020&dev";
...
function createSlice(options) {
  ...
  if (typeof __Process$ !== "undefined" && true) {
...
//# sourceMappingURL=toolkit.development.mjs.map