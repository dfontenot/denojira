import { Style, StyleSheet } from '../utils/style/index.d.ts';
import { HandlerCreator } from './utilities/handler.d.ts';
import type { Config, DictStr, DefaultConfig, DynamicUtility, DefaultTheme, Shortcut, PluginUtils, PluginUtilOptions, PluginOutput, PluginWithOptions, DeepNestObject, UtilityGenerator, VariantGenerator, Validata, StyleArrayObject, PluginCache, ResolvedVariants, VariantTypes, VariantUtils } from '../interfaces.d.ts';
