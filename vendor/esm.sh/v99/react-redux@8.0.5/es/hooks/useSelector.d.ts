 ...
 */
export declare function createSelectorHook(context?: import("https://esm.sh/v99/@types/react@18.0.25/index.d.ts").Context<import("../components/Context.d.ts").ReactReduxContextValue<any, import("https://esm.sh/v99/redux@4.2.0/index.d.ts").AnyAction>>): <TState = unknown, Selected = unknown>(selector: (state: TState) => Selected, equalityFn?: EqualityFn<Selected>) => Selected;
/**
