import { Newable, ServiceIdentifier, LazyServiceIdentifier } from 'https://esm.sh/@inversifyjs/common@1.4.0/lib/esm/index.d.ts';
export { LazyServiceIdentifier } from 'https://esm.sh/@inversifyjs/common@1.4.0/lib/esm/index.d.ts';
import { LegacyTarget } from 'https://esm.sh/@inversifyjs/core@1.3.5/lib/esm/index.d.ts';
