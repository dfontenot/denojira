/* esm.sh - windicss@3.5.6/plugin/forms */
...
// node_modules/windicss/plugin/forms/index.js
var require_forms = __commonJS({
  "node_modules/windicss/plugin/forms/index.js"(exports, module) {
    "use strict";
    ...
    var baseConfig = {
      ...
      theme: {
        ...
        borderColor: function(theme) {
          var _a2;
          return __assign({ DEFAULT: theme("colors.gray.200", "currentColor") }, (_a2 = theme("colors")) !== null && _a2 !== void 0 ? _a2 : {});
        },
        ...
        caretColor: function(theme) {
          var _a2;
          return __assign({ auto: "auto" }, (_a2 = theme("colors")) !== null && _a2 !== void 0 ? _a2 : {});
        },
        ...
        fill: function(theme) {
          var _a2;
          return __assign(__assign({}, (_a2 = theme("colors")) !== null && _a2 !== void 0 ? _a2 : {}), { none: "none" });
        },
        flex: {
          1: "1 1 0%",
          auto: "1 1 auto",
        ...
        height: function(theme, _a2) {
          var _b, _c;
          var breakpoints = _a2.breakpoints;
          return __assign(__assign(__assign(__assign({}, (_b = theme("spacing")) !== null && _b !== void 0 ? _b : {}), tShirtScale), {
            ...
            prose: "65ch",
            screen: "100vh"
          }), breakpoints((_c = theme("screens")) !== null && _c !== void 0 ? _c : {}));
        },
        hueRotate: {
          "-180": "-180deg",
          "-90": "-90deg",
        ...
        inset: function(theme, _a2) {
          var _b;
          var negative = _a2.negative;
        ...
        perspective: function(theme) {
          var _a2;
          return __assign(__assign(__assign({}, (_a2 = theme("spacing")) !== null && _a2 !== void 0 ? _a2 : {}), tShirtScale), { none: "none" });
        },
        perspectiveOrigin: {
          center: "center",
          top: "top",
        ...
        ringColor: function(theme) {
          var _a2;
          return __assign({ DEFAULT: theme("colors.blue.500", "#3b82f6") }, (_a2 = theme("colors")) !== null && _a2 !== void 0 ? _a2 : {});
        },
        ...
        ringOpacity: function(theme) {
          var _a2;
          return __assign({ DEFAULT: "0.5" }, (_a2 = theme("opacity")) !== null && _a2 !== void 0 ? _a2 : {});
        },
        ringWidth: {
          DEFAULT: "3px",
          0: "0px",
      ...
      variantOrder,
      plugins: [
        createPlugin(function(_a2) {
          var addUtilities = _a2.addUtilities;
          addUtilities({
            ".before\\:contents": {
              "&::before": {
                content: '""',
    ...
    var _a = defaultTheme.fontSize.base;
    var baseFontSize = _a[0];
    var baseLineHeight = _a[1].lineHeight;
    var borderWidth = defaultTheme.borderWidth;
    var borderRadius = defaultTheme.borderRadius;
    var spacing = function(num) {
      return "".concat(num / 4, "rem");
    };
    var index = createPlugin(function(_a2) {
      var _b;
      var addBase = _a2.addBase, theme = _a2.theme;
      addBase((_b = {}, _b["\n[type='text'],\n[type='email'],\n[type='url'],\n[type='password'],\n[type='number'],\n[type='date'],\n[type='datetime-local'],\n[type='month'],\n[type='search'],\n[type='tel'],\n[type='time'],\n[type='week'],\n[multiple],\ntextarea,\nselect\n"] = {
        "-webkit-appearance": "none",
        "-moz-appearance": "none",
        "appearance": "none",
...
// endpoint.js
var cjsm = __toESM(require_forms());
...
windicss/plugin/forms/index.js:
  (*! *****************************************************************************
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=forms.development.mjs.map